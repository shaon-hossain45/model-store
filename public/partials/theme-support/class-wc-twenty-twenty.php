...
class MS_Twenty_Twenty {
	...
	public static function init() {
		...
		add_action( 'model_store_before_main_content', array( 'MS_Twenty_Twenty', 'output_content_wrapper' ), 10 );
		add_action( 'model_store_after_main_content', array( 'MS_Twenty_Twenty', 'output_content_wrapper_end' ), 10 );
