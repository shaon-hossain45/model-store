...
class MS_Twenty_Twenty_Two {
	...
	public static function init() {
		...
		add_action( 'woocommerce_checkout_before_order_review_heading', array( 'MS_Twenty_Twenty_Two', 'before_order_review' ) );
		add_action( 'woocommerce_checkout_after_order_review', array( 'MS_Twenty_Twenty_Two', 'after_order_review' ) );
