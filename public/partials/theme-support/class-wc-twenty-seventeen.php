...
class MS_Twenty_Seventeen {
	...
	public static function init() {
		...
		add_action( 'model_store_before_main_content', array( 'MS_Twenty_Seventeen', 'output_content_wrapper' ) );
		add_action( 'model_store_after_main_content', array( 'MS_Twenty_Seventeen', 'output_content_wrapper_end' ) );
