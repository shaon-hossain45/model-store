...
class MS_Twenty_Twenty_Three {
	...
	public static function init() {
		...
		add_action( 'woocommerce_checkout_before_order_review_heading', array( 'MS_Twenty_Twenty_Three', 'before_order_review' ) );
		add_action( 'woocommerce_checkout_after_order_review', array( 'MS_Twenty_Twenty_Three', 'after_order_review' ) );
