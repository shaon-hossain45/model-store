document.addEventListener("DOMContentLoaded", function () {
  var sliderPerview = document
    .querySelector(".swiper")
    .getAttribute("data-perview");
  var sliderBreakpoint = document
    .querySelector(".swiper")
    .getAttribute("data-breakpoint");

  var sliderBreakPhone = document
    .querySelector(".swiper")
    .getAttribute("data-breakphone");
  var sliderBreakTablet = document
    .querySelector(".swiper")
    .getAttribute("data-breaktablet");
  var sliderBreakDesktop = document
    .querySelector(".swiper")
    .getAttribute("data-breakdesktop");
  var sliderBreakLargeScreen = document
    .querySelector(".swiper")
    .getAttribute("data-breaklargescreen");

  var sliderSpeed = document
    .querySelector(".swiper")
    .getAttribute("data-speed");
  var sliderNav = document
    .querySelector(".swiper")
    .getAttribute("data-navigation");
  var sliderPag = document
    .querySelector(".swiper")
    .getAttribute("data-pagination");
  var sliderAutoplay = document
    .querySelector(".swiper")
    .getAttribute("data-autoplay");
  var sliderAutoplayDelay = document
    .querySelector(".swiper")
  ...
  var sliderCenter = document
    .querySelector(".swiper")
    .getAttribute("data-center");
  sliderCenter = sliderCenter == 1 ? true : false;

  var sliderSpaceBet = document
    .querySelector(".swiper")
    .getAttribute("data-spacebetween");

  var sliderEffect = document
    .querySelector(".swiper")
  ...
  var swiper = new Swiper(".swiper-feature", {
    slidesPerView:
      sliderBreakpoint == 1 ? 1 : sliderEffect == 1 ? "auto" : sliderPerview, // Breakpoint dependable
